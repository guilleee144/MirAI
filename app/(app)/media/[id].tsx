        ...
        <View style={{ paddingHorizontal: 20, marginTop: -40 }}>
          ...
          <View style={{ flexDirection: 'row', gap: 16, marginBottom: 20 }}>
            ...
            <View style={{ flex: 1, justifyContent: 'flex-end' }}>
              <Text style={{ color: '#fff', fontSize: 20, fontWeight: '800', letterSpacing: -0.5, marginBottom: 6 }}>
                {title}
              </Text>
              {media.title.native && (
                <Text style={{ color: '#7B8496', fontSize: 12, marginBottom: 8 }}>
                  {media.title.native}
                </Text>
              )}
              {studio && (
                <Text style={{ color: '#B8C1D1', fontSize: 13, marginBottom: 10 }}>{studio}</Text>
              )}
          ...
          <View style={{ flexDirection: 'row', backgroundColor: '#141826', borderRadius: 16, padding: 16, marginBottom: 20, borderWidth: 1, borderColor: 'rgba(255,255,255,0.06)' }}>
            ...
            <View style={{ flex: 1, alignItems: 'center' }}>
              <Text style={{ color: '#fff', fontSize: 18, fontWeight: '700' }}>
                {(media.popularity / 1000).toFixed(0)}K
              </Text>
          ...
          {media.description && (
            <View style={{ marginBottom: 24 }}>
              ...
              <Text style={{ color: '#B8C1D1', fontSize: 14, lineHeight: 22 }}>
                  ...
                  .map((node: any) => {
                    ...
                    return (
                      <TouchableOpacity
                        key={rec.id}
                        activeOpacity={0.85}
                        onPress={() => router.push(`/(app)/media/${rec.id}?type=${rec.type}` as any)}
                      >
