...
// Migrated from app/(app)/index.tsx.
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 40 }}>
        ...
        >
          <View>
            ...
            <Text style={{ color: '#fff', fontSize: 22, fontWeight: '700', marginTop: 2 }}>MirAI</Text>
          </View>
        ...
        <View style={{ paddingHorizontal: 20, marginTop: 16 }}>
          <TouchableOpacity onPress={() => navigation.navigate('Chat' as never)} activeOpacity={0.9}>
            <LinearGradient
              ...
              <TouchableOpacity key={item.id} activeOpacity={0.85}>
                ...
                >
                  <LinearGradient colors={item.gradient} style={{ flex: 1, padding: 12, justifyContent: 'flex-end' }}>
                    <Text style={{ color: '#fff', fontSize: 12, fontWeight: '700', marginBottom: 4 }}>
                      {item.title}
                    </Text>
        ...
        <View style={{ paddingHorizontal: 20, marginTop: 28 }}>
          ...
          >
            ...
            <TouchableOpacity onPress={() => navigation.navigate('Discover' as never)} style={{ marginTop: 12 }}>
