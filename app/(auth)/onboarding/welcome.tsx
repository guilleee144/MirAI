    ...
    <View style={{ flex: 1, backgroundColor: '#0B0F17' }}>
      ...
      <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 32 }}>
        ...
        <View style={{ alignItems: 'center', marginBottom: 16 }}>
          <Text style={{ fontSize: 48, fontWeight: '800', color: '#fff', letterSpacing: -2 }}>
            MirAI
          </Text>
          <Text style={{ fontSize: 13, color: '#7B8496', letterSpacing: 4, textTransform: 'uppercase', marginTop: 4 }}>
            未来 · Future
          </Text>
        </View>
