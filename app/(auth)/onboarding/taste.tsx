...
export default function TasteScreen() {
  ...
  const handleContinue = async () => {
    ...
    router.push('/(auth)/onboarding/connect' as any)
  }
    ...
    <View style={{ flex: 1, backgroundColor: '#0B0F17' }}>
      ...
      >
            ...
            return (
              ...
              >
                <View style={{
                  ...
                  {selected && (
                    <Text style={{ color: '#6C5CE7', fontSize: 16 }}>✓</Text>
                  )}
                </View>
              </TouchableOpacity>
            )
        ...
        <Text style={{ color: '#7B8496', fontSize: 13, textAlign: 'center', marginBottom: 20 }}>
          {selectedGenres.length} genres selected {selectedGenres.length < 3 ? `(${3 - selectedGenres.length} more needed)` : '✓'}
        </Text>
